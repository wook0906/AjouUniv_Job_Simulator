...
public class Volt_PlayerManager : MonoBehaviour
{
    ...
    public void CreatePlayer(PlayerType newPlayerType,int playerNumber, RobotType robotType, SkinType skinType, string nickName)
    {
        Managers.Resource.InstantiateAsync("Game/Contents/Player.prefab").Completed += (result) =>
        {
            ...
            GameController.instance.gameData.playerDict.Add(playerNumber, newPlayer);
        };
            ...
            if (I != null)
            {
                ...
                switch (GameController.instance.CurrentPhase.type)
                {
                    case Define.Phase.PlaceRobot:
                        ...
                        break;
                    case Define.Phase.SelectBehaviour:
                    ...
                    case Define.Phase.Synchronization:
