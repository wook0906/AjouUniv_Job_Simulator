...
public class Volt_Tile : MonoBehaviour
{
    ...
    public void SetVictoryPoint()
    {
        ...
        GameController.instance.gameData.remainRoundCountToVpSetup = GameController.instance.gameData.vpSetupInterval;
        ...
        if(GameController.instance.CurrentPhase.type == Define.Phase.ItemSetup)
    ...
    public void OnTouchBegin()
    {
        ...
        //        break;
        //}
        GameController.instance.CurrentPhase.OnTouchTileBegin(this);
    }
    public void OnTouch()
    {
        GameController.instance.CurrentPhase.OnTouchTile(this);
        //switch (Volt_GameManager.S.pCurPhase)
        //{
        //    case Phase.none:
        //        break;
    ...
    {
        GameController.instance.CurrentPhase.OnTouchTileEnd(this);
        //switch (Volt_GameManager.S.pCurPhase)
        //{
        //    case Phase.none:
        //        break;
        ...
        //                    curPhase.SelectRangeDoneCallback(this);
        //                }
        //            }
        //            else
        //            {
