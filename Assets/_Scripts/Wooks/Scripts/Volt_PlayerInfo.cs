        ...
        set
        {
            if (value >= 0)
            {
                ...
                if (vp >= 3)
                {
                    ...
                    GameController.instance.SendAchievementProgressPacketBeforeGameOver(playerNumber);
                }
            }
        }
    }
        ...
        switch(GameController.instance.CurrentPhase.type)
        {
            ...
            case Define.Phase.SelectRange:
                if (PlayerType == PlayerType.HOSTPLAYER)
                {
                    ...
                    SelectRange phase = GameController.instance.CurrentPhase as SelectRange;
                    phase.DoAllKillbotsDetection();
                }
                break;
            default:
                break;
