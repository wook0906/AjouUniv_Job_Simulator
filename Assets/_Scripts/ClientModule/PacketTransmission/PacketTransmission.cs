...
public static class PacketTransmission
{
    ...
    public static void SendVictoryPointPacket(int playerNumber, int vp)
    {
        ...
        if (GameController.instance.gameData.isEndlessGame) return;
    ...
    public static void SendTotalTurnOverPacket(TileData[] newStateTileDatas, RobotData[] robotDatas, PlayerData[] playerDatas)
    {
        ...
        ByteConverter.FromInt(GameController.instance.gameData.remainRoundCountToVpSetup, buffer, ref startIndex);
        //------------------------------------------------------------------------------
    ...
    public static void SendRequestGameUserInfoInitPacket()
    {
        byte[] buffer = IOBuffer.Dequeue();
        ...
        ByteConverter.FromInt((int)EPacketType.GameUserInfoInitPacket, buffer, ref startIndex);
