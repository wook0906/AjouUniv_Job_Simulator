...
public class SynchronizationElsePacket : Packet
{
    public override void UnPack(byte[] buffer)
    {
        ...
        Synchronization phase = GameController.instance.CurrentPhase as Synchronization;
        ...
        try
        {
            for (int index = 0; index < numOfPlayer; index++)
            {
                ...
                GameController.instance.gameData.robotDatas.Enqueue(robotData);
        ...
        for (int index = 0; index < numOfPlayer; index++)
        {
            ...
            GameController.instance.gameData.playerDatas.Enqueue(playerData);
