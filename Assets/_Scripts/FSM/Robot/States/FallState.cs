...
public class FallState : StateBase
{
    ...
    public override void OnEnterState(StateMachine fsm)
    {
        ...
        //if (Volt_GameManager.S.mapType == Define.MapType.Rome)
        if(GameController.instance.gameData.mapType == Define.MapType.Rome)
        {
        ...
        {
            if(SimulationObserver.Instance.currentPusher != null)
